...
class TestMultiThreadedEvent : public ::testing::Test
{
protected:
...
TEST_F(TestMultiThreadedEvent, create) {
  // Create with default properties
  auto events = new rti::ros2::node::MultiThreadedEventNotifier();
  (void)events;
  // Create with custom properties
  rti::core::cond::AsyncWaitSetProperty props;
  events = new rti::ros2::node::MultiThreadedEventNotifier(props);
}

TEST_F(TestMultiThreadedEvent, notify) {
  ...
  rti::ros2::node::MultiThreadedEventNotifier events;
