...
#include "test_notifier.hpp"

class TestNotifier : public ::testing::Test
{
protected:
  ...
  rclcpp::Node::SharedPtr node_b)
{
  ...
  auto cft_topic = ros2dds::create_filtered_topic<String>(
  ...
  auto condition_data_a_1 = notifier.template read_data_callback<String>(node_a_reader_1,
  ...
  // Query data callback
  auto condition_data_a_2 = notifier.template read_data_callback<String>(node_a_reader_2,
    [&state](const String & msg)
    {
      (void)msg;
  ...
  auto condition_data_a_3 = notifier.template data_callback<String>(node_a_reader_3,
    [&state](
  ...
  auto condition_data_a_4 = notifier.template data_callback<String>(node_a_reader_4,
    [&state](
  ...
  auto condition_status_a_1 =
    notifier.template status_callback<String>(node_a_reader_1, on_reader_status,
      dds::core::status::StatusMask::subscription_matched());
  auto condition_status_a_2 =
    notifier.template status_callback<String>(node_a_reader_2, on_reader_status,
      dds::core::status::StatusMask::subscription_matched());
  auto condition_status_a_3 =
    notifier.template status_callback<String>(node_a_reader_3, on_reader_status,
      dds::core::status::StatusMask::subscription_matched());
  auto condition_status_a_4 =
    notifier.template status_callback<String>(node_a_reader_4, on_reader_status,
      dds::core::status::StatusMask::subscription_matched());
  ...
  auto condition_status_b = notifier.template status_callback<String>(node_b_writer,
    [&state](
        dds::core::cond::StatusCondition & condition,
  ...
  wait_with_timeout(notifier, 1000ms, 50ms,
    [&state](){
      return
  ...
  notifier.detach(condition_data_a_1);
  notifier.detach(condition_status_a_1);
  ...
  notifier.detach(condition_status_a_2);
  ...
  notifier.detach(condition_status_b);
  node_b_writer.close();
...
class TestAsyncNotifier : public TestNotifier {};

TEST_F(TestAsyncNotifier, create) {
  // Create with default properties
  ros2dds::AsyncConditionNotifier notifier;
  (void)notifier;
}

TEST_F(TestAsyncNotifier, notify) {
  test_notifier<ros2dds::AsyncConditionNotifier>(node_a, node_b);
}

class TestSyncNotifier : public TestNotifier {};

TEST_F(TestSyncNotifier, create) {
  // Create with default properties
  ros2dds::SyncConditionNotifier notifier;
  (void)notifier;
}

TEST_F(TestSyncNotifier, notify) {
  test_notifier<ros2dds::SyncConditionNotifier>(node_a, node_b);
}
